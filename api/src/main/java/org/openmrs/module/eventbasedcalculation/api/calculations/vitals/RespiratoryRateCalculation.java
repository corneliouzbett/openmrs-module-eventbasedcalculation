...
public class RespiratoryRateCalculation extends BaseCalculation implements PatientCalculation {

    private static final String RESPIRATORY_CONCEPT_UUID = "";
    ...
    public CalculationResultMap evaluate(Collection<Integer> collection, Map<String, Object> map, PatientCalculationContext patientCalculationContext) {
        return Calculation.lastObs(Calculation.getConceptByUuid(RESPIRATORY_CONCEPT_UUID), collection, patientCalculationContext);
    }
}
